...
for station in stations:
    ...
    query1 = 'SELECT  extract(DAY from datecapture), latitude, longitude FROM is_cloud WHERE latitude='+str(station[0])+' AND longitude='+str(station[1])+' ORDER BY datecapture limit 150'
    print(query1)

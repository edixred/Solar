#Scrip para guardar los mapas de Viento  resultantes
import os
import sys
import psycopg2
import io
    ...
    for x in range(0, sizeYRows, 1): #recorrer el tif horizontalmente
        for y in range(0,sizeXCols,  1):#recorrer el tif verticalmente
            ...
            if m1[x][y]<250:
                ...
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"January"+";"+str(vmap1)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"February"+";"+str(vmap2)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"March"+";"+str(vmap3)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"April"+";"+str(vmap4)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"May"+";"+str(vmap5)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"June"+";"+str(vmap6)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"July"+";"+str(vmap7)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"August"+";"+str(vmap8)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"September"+";"+str(vmap9)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"October"+";"+str(vmap10)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"November"+";"+str(vmap11)+";"+str(3)+"\n")
                bdtiff.write(str(math.trunc(latitude))+";"+str(math.trunc(longitude))+";"+"December"+";"+str(vmap12)+";"+str(3)+"\n")
    bdtiff.close()
    print "... CONECTANDO"
    try:        
